...
function LocationDataAlternate(historyData,dataRealT,contract) {
    ...
    useEffect(()=>{
        ...
        if(historyState !== undefined) {
            ...
            const lineROI = arrayRoi.length < 2 ? parseFloat(arrayRoi[closestIndex].roi):(parseFloat(arrayRoi[closestIndex].roi)+parseFloat(arrayRoi[closestIndex+1].roi))/2
            const lineRoiObj = {
                roi:lineROI,
            ...
            setRoi(arrayRoi)
            const lineRent = arrayRoi.length < 2 ?parseFloat(arrayRent[closestIndex].rent):(parseFloat(arrayRent[closestIndex].rent)+parseFloat(arrayRent[closestIndex+1].rent))/2
            const lineRentObj = {
