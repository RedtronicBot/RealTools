...
function Carousel({img,name,selectedLocation,onIndexLocation}) {
    ...
    return (
        <div className='map_carousel'>
            ...
            {selectedLocation.length > 1 &&<div className='map_carousel_same_location'>
                <div onClick={()=>prevLocation()} className='map_carousel_same_location_compontents'><img src={chevron} alt='chevron' height={12} /></div>
                <div className='map_carousel_same_location_compontents'><p>{indexLocation + 1}</p></div>
                <div onClick={()=>nextLocation()} className='map_carousel_same_location_compontents'><img src={chevron} alt='chevron' height={12} /></div>
            </div>}
