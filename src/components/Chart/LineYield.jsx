...
function LineChartYield({datachart,datainitial}){
    ...
    const data = {
        ...
        datasets: [
            {
                label: 'Yield',
                data: datachart.map(field=>field.yield),
            ...
            {
                label: 'Yield Initial',
                data: array.map(field=>field.yield), 
