...
function Loyer({ data, dataRealT, setKey, rentData }) {
	...
	const { interestDataAlternate } = InteretComposeAlternateData(
		dataRealT,
		data,
		rentData,
		investmentWeek,
	...
	const { interestDataProj, realData } = InteretRealData(
		dataRealT,
		data,
		rentData,
		investmentWeekReal,
		monthInvestmentReal,
		setInvestmentWeekReal,
		investmentRef,
		compoundInterestReal,
		investmentRefExpand,
		open,
		expand
	)
	const { interestDataProjAlternate, realDataAlternate } = InteretRealAlternateData(
		dataRealT,
		data,
		rentData,
		investmentWeekReal,
		...
		<div className="loyer">
				...
				<div className="dashboard_text_stats">
					...
					<div className="loyer_graph_loyer_cumule">
						...
						<img
							src={maximize}
							alt=""
							className="loyer_expand_img"
							width={24}
							onClick={() => onSetExpand("loyer")}
						/>
					</div>
				</div>
			</div>
			<div className="dashboard_bloc_stats">
					...
					<div className="loyer_chart_input_bloc">
						<div className="loyer_title">
							<h2>
								...
								{compoundInterest
									? `Base en cours : ${
											interestData.length > 0 && interestData[0].capital.toFixed(2)
									  } $`
									: `Base Total : ${
											interestDataAlternate.length > 0 &&
											interestDataAlternate[0].capital.toFixed(2)
									  } $`}
								)
							</h2>
							<div className="loyer_bloc_checkbox">
								...
								<div className="loyer_checkbox" onClick={() => onSetCompoundInterest()}>
									<div
										className={`loyer_checkbox_components ${compoundInterest ? "true" : "false"}`}
									></div>
								</div>
								<p>En cours</p>
								<div className="dashboard_text_stats_info_border">
									...
									/>
									<span>
										Total: Intérêt de l'investisement total
										<br />
										En cours: Intérêt calculé en tenant compte du fait que le logement est loué
									</span>
								</div>
							</div>
						</div>
							...
							<div className="loyer_chart_input">
								...
								<div className="loyer_chart_input_components">
									...
									<input
										type="number"
										defaultValue={50}
										onChange={(e) => setInvestmentWeek(e.target.value)}
									/>
								</div>
							</div>
							<div className="loyer_chart_input">
								...
								<input
									type="number"
									defaultValue={12}
									onChange={(e) => setMonthInvestment(e.target.value)}
								/>
							</div>
						</div>
					</div>
				...
				<div className="loyer_chart">
					<div className="loyer_chart_input_bloc">
						<div className="loyer_title">
							<h2>
								...
								{realData.length > 0 && realDataAlternate.length > 0 && compoundInterestReal
									? `Base en cours : ${
											realData.length > 0 && realData[realData.length - 1].capital.toFixed(2)
									  } $`
									: `Base Total : ${
											realDataAlternate.length > 0 &&
											realDataAlternate[realDataAlternate.length - 1].capital.toFixed(2)
									  } $`}
								)
							</h2>
							<div className="loyer_bloc_checkbox">
								...
								<div className="loyer_checkbox" onClick={() => onSetCompoundInterestReal()}>
									<div
										className={`loyer_checkbox_components ${
											compoundInterestReal ? "true" : "false"
										}`}
									></div>
								</div>
								<p>En cours</p>
						...
						<div className="loyer_chart_input_bloc_components">
							<div className="loyer_chart_input">
								...
								<div className="loyer_chart_input_components">
									...
									<input
										type="number"
										value={investmentWeekReal.toString() || ""}
										onChange={(e) => setInvestmentWeekReal(e.target.value)}
									/>
								</div>
							</div>
							<div className="loyer_chart_input">
								...
								<input
									type="number"
									defaultValue={12}
									onChange={(e) => setMonthInvestmentReal(e.target.value)}
								/>
							</div>
						</div>
					</div>
					<div className="loyer_graph_interet">
						<InteretComposeReel
							datachart={compoundInterestReal ? interestDataProj : interestDataProjAlternate}
							datareal={compoundInterestReal ? realData : realDataAlternate}
							dataloyer={rentData}
						/>
						<img
							src={maximize}
							...
							className="loyer_expand_img"
							width={24}
							onClick={() => onSetExpand("interestReal")}
						/>
					</div>
				</div>
			</div>
									...
									<div className="loyer_bloc_checkbox">
										...
										<div className="dashboard_text_stats_info_border">
											...
											<span>
												Total: Intérêt de l'investisement total
												<br />
												En cours: Intérêt calculé en tenant compte du fait que le logement est
												loué
											</span>
										</div>
									</div>
									...
									<div className="loyer_expand_title">
										<h2>
											...
											{realData.length > 0 && realDataAlternate.length > 0 && compoundInterestReal
												? `Base en cours : ${
														realData.length > 0 &&
														realData[realData.length - 1].capital.toFixed(2)
												  } $`
												: `Base Total : ${
														realDataAlternate.length > 0 &&
														realDataAlternate[realDataAlternate.length - 1].capital.toFixed(
															2
														)
												  } $`}
											)
										...
										<div className="loyer_bloc_checkbox">
											...
											<div className="dashboard_text_stats_info_border">
												...
												<span>
													Total: Intérêt de l'investisement total
													<br />
													En cours: Intérêt calculé en tenant compte du fait que le logement
													est loué
												</span>
											</div>
										</div>
